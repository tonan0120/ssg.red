...
/*创建SQL语句*/
$sql="delete from zhan where id = '$_GET[id]'";
...
echo "<div class='kuang'><div  class='wangzhi'><div  align='center'>	<h4>数据删除成功！</h4><a class='title' href='./houtai.php'>返回</a></div></div></div>";
