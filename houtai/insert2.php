...
/*创建SQL语句*/
$sql="insert into lei (leixing) values ('$_POST[leixing]')";
...
echo "<div class='kuang'><div  class='wangzhi'><div  align='center'>	<h4>新类别添加成功！</h4><a class='title' href='./houtai.php'>返回</a></div></div></div>";
